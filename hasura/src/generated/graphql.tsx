...
export const Get_User_LocationDocument = gql`
  ...
  users(where: {id: {_eq: $id}}) {
    ...
    `;
export type Get_User_LocationComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<Get_User_LocationQuery, Get_User_LocationQueryVariables>, 'query'> & ({ variables: Get_User_LocationQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const Get_User_LocationComponent = (props: Get_User_LocationComponentProps) => (
      <ApolloReactComponents.Query<Get_User_LocationQuery, Get_User_LocationQueryVariables> query={Get_User_LocationDocument} {...props} />
    );
    
export type Get_User_LocationProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<Get_User_LocationQuery, Get_User_LocationQueryVariables>
    } & TChildProps;
export function withGet_User_Location<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  Get_User_LocationQuery,
  Get_User_LocationQueryVariables,
  Get_User_LocationProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, Get_User_LocationQuery, Get_User_LocationQueryVariables, Get_User_LocationProps<TChildProps, TDataName>>(Get_User_LocationDocument, {
      alias: 'getUserLocation',
      ...operationOptions
    });
};
...
export type Update_User_LocationComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<Update_User_LocationMutation, Update_User_LocationMutationVariables>, 'mutation'>;

    export const Update_User_LocationComponent = (props: Update_User_LocationComponentProps) => (
      <ApolloReactComponents.Mutation<Update_User_LocationMutation, Update_User_LocationMutationVariables> mutation={Update_User_LocationDocument} {...props} />
    );
    
export type Update_User_LocationProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: ApolloReactCommon.MutationFunction<Update_User_LocationMutation, Update_User_LocationMutationVariables>
    } & TChildProps;
export function withUpdate_User_Location<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  Update_User_LocationMutation,
  Update_User_LocationMutationVariables,
  Update_User_LocationProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, Update_User_LocationMutation, Update_User_LocationMutationVariables, Update_User_LocationProps<TChildProps, TDataName>>(Update_User_LocationDocument, {
      alias: 'updateUserLocation',
      ...operationOptions
    });
};
