 ...
 * });
 */
export function useGet_User_Pa_AlertsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<Get_User_Pa_AlertsQuery, Get_User_Pa_AlertsQueryVariables>) {
        return ApolloReactHooks.useQuery<Get_User_Pa_AlertsQuery, Get_User_Pa_AlertsQueryVariables>(Get_User_Pa_AlertsDocument, baseOptions);
      }
export function useGet_User_Pa_AlertsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<Get_User_Pa_AlertsQuery, Get_User_Pa_AlertsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<Get_User_Pa_AlertsQuery, Get_User_Pa_AlertsQueryVariables>(Get_User_Pa_AlertsDocument, baseOptions);
        }
export type Get_User_Pa_AlertsQueryHookResult = ReturnType<typeof useGet_User_Pa_AlertsQuery>;
export type Get_User_Pa_AlertsLazyQueryHookResult = ReturnType<typeof useGet_User_Pa_AlertsLazyQuery>;
export type Get_User_Pa_AlertsQueryResult = ApolloReactCommon.QueryResult<Get_User_Pa_AlertsQuery, Get_User_Pa_AlertsQueryVariables>;
...
export const Set_User_AlertsDocument = gql`
  ...
  insert_user_pa_status(objects: $objects) {
    ...
    `;
export type Set_User_AlertsMutationFn = ApolloReactCommon.MutationFunction<Set_User_AlertsMutation, Set_User_AlertsMutationVariables>;
 ...
 * });
 */
export function useSet_User_AlertsMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<Set_User_AlertsMutation, Set_User_AlertsMutationVariables>) {
        return ApolloReactHooks.useMutation<Set_User_AlertsMutation, Set_User_AlertsMutationVariables>(Set_User_AlertsDocument, baseOptions);
      }
export type Set_User_AlertsMutationHookResult = ReturnType<typeof useSet_User_AlertsMutation>;
export type Set_User_AlertsMutationResult = ApolloReactCommon.MutationResult<Set_User_AlertsMutation>;
export type Set_User_AlertsMutationOptions = ApolloReactCommon.BaseMutationOptions<Set_User_AlertsMutation, Set_User_AlertsMutationVariables>;